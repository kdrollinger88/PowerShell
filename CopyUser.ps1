...
$TargetAddress = "SMTP:" + $Username + "@mycompany.mail.onmicrosoft.com"
$ExchangeServer = "Exchange2010.mycompany.local"
...
$Session = New-PSSession -ConfigurationName Microsoft.Exchange -ConnectionUri http://exchange2010.nffc.local/PowerShell/ -Authentication Kerberos -Credential $creds -Name Exchange
...
$session =New-PSSession -ComputerName adconnect -Credential $creds
